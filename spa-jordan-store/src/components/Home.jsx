...
function Home() {
    ...
    return <div className="Home">
      <header>
        <div className='NavBar__container'>
          <img className='NavBar__container--icon' src={require("../assets/img/nike.png")} alt="Icone Nike "/>
          <a href="#" className="NavBar__container--home">Home</a>
  ...
  //         <a href="https://github.com/thulerjoao">github.com/thulerjoao </a>
  //         - 2022            
  //     </p>
  //   </div>